...
<body>
    ...
    <div class="konten-wrapper">
        ...
        <div class="foto-hiasan">
            <img src="{{ asset('image/bluefinance.jpg') }}" alt="">
        </div>
    </div>
    <!-- konten baris 2 -->
    <div class="container-baris2">
        <img src="{{ asset('image/foto-landingpage2.jpg') }}" class="foto-landingpage2" alt="">
        <h2>Uang bukan segalanya. Tapi <span>pengelolaan uang yang baik</span> membuat segalanya lebih mudah.</h2>
    </div>

    <footer class="container-footer">
        <div class="konten-footer">
            <div class="footer-baris1">
            ...
            <p class="teks1-footer">&copy; 2025 Sistem Manajemen Keuangan Pribadi. All rights reserved.</p>
            <p><a href="#">Tentang</a> | <a href="#">Kontak</a> | <a href="#">Kebijakan Privasi</a></p>
        </div>
    </footer>
